r"""
train_unet_coverage.py — PrediCT CAC Segmentation — 3D U-Net on Coverage labels
============================================================================
Identical to the ROI baseline (Train_3D_Unet_ROI.py) except:
  - data_root should point to soft coverage labels (images_roi_cov/)
  - separate cache dirs to avoid loading binary labels
  - the model learns to predict sub-pixel area fractions [0.0 - 1.0]

USAGE (PowerShell):
  & c:\SOHAM\vmenv\Scripts\python.exe c:/SOHAM/src/training/Train_3D_Unet_Coverage.py `
    --data_root "C:\SOHAM\coca_raw\cocacoronarycalciumandchestcts-2\data_canonical\images_roi_cov" `
    ...
    --out_dir   "C:\SOHAM\runs\approach3_coverage"
"""
...
# Separate cache from the A1 runs -- different data, kept distinct.
CACHE_DIR_TRAIN = r"C:\SOHAM\cache\train_roi_cov"
CACHE_DIR_VAL   = r"C:\SOHAM\cache\val_roi_cov"
...
def main():
    ...
    # We threshold the soft labels at 0.5 strictly for the Dice tracker.
    # The TverskyLoss above calculates gradients off the raw continuous [0,1] fractions.
